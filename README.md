...
**goldgenerator.py:** Harmonizes disparate Freddie and Fannie schemas and aggregates the parquet partitions into a unified dataset and maps institutional sentinel values to high-integrity nulls.

**24kgoldgenerator.py:** Performs the massive time-series join between Agency data and FMHPI data.

**final_polish.py:** Executes surgical cleaning on strings and geographic codes (these issues can be revealed by running on audit_24k on the dataset generated by **24kgoldgenerator.py**).
